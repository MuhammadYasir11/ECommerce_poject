...
<section class="content-header">					
				...
				<section class="content">
					...
					<div class="container-fluid">
						<form action=""  name="childCategoryForm" id="childCategoryForm">
						<div class="card">
							<div class="card-body">								
								<div class="row">
                                    <div class="col-md-6">
									...
									<div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="slug" readonly="true" id="slug" class="form-control" placeholder="Slug">	
										<p></p>
										</div>
									</div>	
									<div class="col-md-6">
                ...
                @section('customJs')
                    <script>
                        ...
                        $("#childCategoryForm").submit(function(event){
                            event.preventDefault();
                            var element = $("#childCategoryForm");
