...
<section class="content-header">					
				...
				<!-- Main content -->
                <form action="" name="EditproductForm" id="EditproductForm" method="post">
                                ...
                                <div class="card mb-3">
                                    <div class="card-body">								
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    <label for="description">Shiping and Returns</label>
                                                    <textarea name="shiping_returns" id="shiping_returns" cols="30" rows="10" class="summernote" placeholder="Shiping Returns">{{ $product->shopping_returns}}</textarea>
                                                </div>
                                            </div>                                           
                                        </div>
                                    </div>	                                                                      
                                ...
                                <div class="card mb-3">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                         <div class="mb-3">
                                         <label for="barcode">Related Products</label>	
                                            <div class="mb-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    <div class="custom-control custom-checkbox">
                                                        ...
                                                        checked value="Yes" {{ ($product->track_qty == 'Yes') ? 'checked' : '' }}>
