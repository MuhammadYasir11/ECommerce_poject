        ...
        <div class="container">
            <div class="row">            
                <div class="col-md-3 sidebar">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <input type="text" name="my_range" class="js-range-slider" value="" />
                    ...
                    <div class="row pb-3">
                        <div class="col-12 pb-1">
                            ...
                            <select name="sort" id="sort" class="form-control">
                                ...
                                <option value="price_asc" {{ ($sort == 'pric e_asc')? 'selected' : '' }}>Price Low</option>
                            </select>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    }).data("ionRangeSlider"); // Initialize and get the ionRangeSlider instance
