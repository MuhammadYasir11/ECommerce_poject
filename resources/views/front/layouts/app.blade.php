...
<head>
	...
	<!-- Fav Icon -->
	<link rel="shortcut icon" type="{{ asset('front-assets/image/x-icon')}}" href="#" />
		...
		<div class="row">
			<div class="col-md-4">
				<div class="footer-card">
					<h3>Get In Touch For Customer</h3>
					<p>Muhammad Yasir. <br>
					 <br>
					muhammadyasir.aptech@gmail.com <br>
					</p>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="footer-card">
					...
					<ul>
						<li><a href="{{ route('front.about-us') }}" title="About">About</a></li>
